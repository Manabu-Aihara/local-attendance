...
class AttendanceAnalysys:
    ...
    def __init__(self, c, data0, data1, data2, data3, data_4, data5, data6, data7, data8, data9, data10, data11, staffid):
        self.c = c
        self.data0 = data0
        self.data1 = data1
        self.data2 = data2
    ...
    def analysys(self):
        ...
        if self.c.strftime('%Y-%m-%d') == self.data1 and sh:   # 登録上書き
            ...
            if ((self.data7 != "7" or self.data7 != "8" or self.data7 != "17" or self.data7 != "18" or self.data7 != "19" or self.data7 != "20") and \
                not (self.data7 == "" and self.data11 == "" and self.data2 == "00:00" and self.data3 == "00:00")) and \

...
def get_pulldown_list():
    with app.app_context():
        ...
        contract_opt = GetPullDownList(KinmuTaisei, KinmuTaisei.CONTRACT_CODE, KinmuTaisei.NAME, KinmuTaisei.CONTRACT_CODE)
        jobtype_opt = GetPullDownList(Jobtype, Jobtype.JOBTYPE_CODE, Jobtype.NAME, Jobtype.JOBTYPE_CODE)
